...
//static bool disable_usb_charger=false;//liyongfeng add for ft test mode can not get port 
/* Mask/Bit helpers */
...
//         if(disable_usb_charger)//liyongfeng add for ft test mode can not get port 
//         {
//               current_limit=0;
//         }
...
static int smb_parse_dt(struct smbchg_chip *chip)
{
 ...
 //	if(disable_usb_charger==false)
 // disable_usb_charger=of_property_read_bool(node, "qcom,disable-usb-charger");//liyongfeng add for ft test mode can not get port 
...
static int smbchg_probe(struct spmi_device *spmi)
{
 ...
 //     if(disable_usb_charger==false)//liyongfeng add for ft test mode can not get port 
//	{
