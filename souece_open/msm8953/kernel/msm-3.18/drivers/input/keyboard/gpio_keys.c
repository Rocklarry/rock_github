...
static int gpio_keys_open(struct input_dev *input)
{
	...
	int error;
        void __iomem *regs;
        regs = base_iomem();
        //writel(0x201, regs + 0x2d000); //gpio45--->0x2d 
        //writel(0x03, regs + 0x2d004); //gpio45--->0x2d
        //writel(0x03, regs + 0x5a000); //gpio90--->0x5a
        //writel(0x03, regs + 0x5a004);  //gpio90--->0x5a
	if (pdata->enable) {
...
static int gpio_keys_probe(struct platform_device *pdev)
{
	...
	void __iomem *regs;
	regs = base_iomem();
        //writel(0x201, regs + 0x2d000);
       // writel(0x03, regs + 0x2d004);
        //dev_err(dev, "ZJY set gpio45 pull up\n");
	if (!pdata) {
