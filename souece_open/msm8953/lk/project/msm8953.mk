...
#Add by lukai for PMI8952 contorl backlight
ifeq ($(BSP_SELECT_ID),SC826_CN_01_00)
else
DEFINES += PMI8950_SUPPORT=1
endif

ifeq ($(strip $(BSP_SELECT_ID)),$(filter $(BSP_SELECT_ID),SC826_CN_01_00 SC826_CN_00_00))
DEFINES += FIBOCOM_FTMODE_BID=0
else
DEFINES += FIBOCOM_FTMODE_BID=8
endif
