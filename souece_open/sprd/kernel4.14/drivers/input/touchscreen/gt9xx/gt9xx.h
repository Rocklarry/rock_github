...
#ifdef CONFIG_FIBO_DEVICES
#include <linux/fibo_devices.h>
#endif
...
#define GOODIX_CFG_GROUP_NUM   2
#define GTP_FW_NAME_MAXSIZE 50
#define GOODIX_MAX_PID_GROUP 10
...
struct goodix_ts_platform_data {
    ...
    size_t config_data_len[GOODIX_MAX_CFG_GROUP][GOODIX_CFG_GROUP_NUM];
    u8* config_data[GOODIX_MAX_CFG_GROUP][GOODIX_CFG_GROUP_NUM];
...
struct goodix_ts_data {
    ...
    u8  gtp_is_suspend;
    u8  gtp_rawdiff_mode;
    u8  gtp_cfg_len[GOODIX_CFG_GROUP_NUM];
    u8  fixed_cfg;
    u8  esd_running;
    u8  fw_error;
    bool power_on;
...
#endif
    u8 init_done;
    u8 chip_gt9xxs;  /* true if ic is gt9xxs, like gt915s */
    u32 cfg_index;
