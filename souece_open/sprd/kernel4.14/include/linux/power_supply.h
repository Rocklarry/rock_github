...
#define POWER_SUPPLY_CAP_TEMP_MAX 100
...
extern int power_supply_find_ocv(struct power_supply_battery_info *info,
                                int batt_temp, int ocv);
extern int power_supply_find_rint(struct power_supply_battery_info *info,
