...
{
  int ret1 = i2c_write_check_reg(file_des, 0x00, 0b01111000); //0x09,0x00    //8 sample average, 75hz  0x78
  ...
  int ret3 = i2c_write_check_reg(file_des, 0x02, 0x00); //set饱和之后reset  (0x08,0x08)
  delay()
  int ret3 = i2c_write_check_reg(file_des, 0x02, 0x00); //TM_M 开始测量 	(0x08,0x01)
delay()
