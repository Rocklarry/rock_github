/*************************************************************************
	...
	> Author: rock
	> Mail: rock@163.com 
	> Created Time: 2017年10月14日 星期六 15时20分42秒
 ************************************************************************/
...
void* heart_handler(void* arg)
{
    ...
    while(1)
    {
        ...
        {   
            ...
            {
                cout << "The client second.first=" << it->second.first << "  second.second=" << it->second.second <<" has be offline.\n";
            ...
            else if(it->second.second < 5 && it->second.second >= 0)
            {
                it->second.second += 1;
                ++it;
				cout << "second.second=" << it->second.second << "  it \n";
            }
            else
            {
                ++it;
		...
		//cout << "s=" << s << "  s \n";
		cout << "s=" << it->second.second << "  s \n";
		
        usleep(1000*500);   // 定时三秒
    }
}
