/*************************************************************************
	...
	> Author: rock
	> Mail: rock@163.com 
	> Created Time: 2018年03月16日 星期五 14时13分31秒
 ************************************************************************/
...
//_syscall3(int,inotify_add_watch,int,fd,const char *,path,_u32,mask)
//_syscall2(int,inotify_rm_watch,int,fd,_u32,mask)
...
int main(void)
{
	...
	fd = inotify_init();
	if(fd<0){
		printf("faile to initialize inotify.\n");
		exit(-1);
	}
