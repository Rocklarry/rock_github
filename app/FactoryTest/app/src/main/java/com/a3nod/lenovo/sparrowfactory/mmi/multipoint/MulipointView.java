...
public class MulipointView extends SurfaceView implements SurfaceHolder.Callback
{
    private static final int MAX_TOUCHPOINTS = 10;
    private static final String START_TEXT = "touch screen to start test";
    ...
    public MulipointView(Context context)
    {
        super(context);
    ...
    public MulipointView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        SurfaceHolder holder = getHolder();
        holder.addCallback(this);
