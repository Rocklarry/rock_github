...
public class GLTutorialCube extends GLCubeBase  {
    ...
    public GLTutorialCube(Context c) {
        ...
        bmp[0] = BitmapFactory.decodeResource(c.getResources(), R.drawable.deep_blue_small);
        bmp[1] = BitmapFactory.decodeResource(c.getResources(), R.drawable.green_small);
        bmp[2] = BitmapFactory.decodeResource(c.getResources(), R.drawable.red_small);
        bmp[3] = BitmapFactory.decodeResource(c.getResources(), R.drawable.yellow_small);
        bmp[4] = BitmapFactory.decodeResource(c.getResources(), R.drawable.white_small);
        bmp[5] = BitmapFactory.decodeResource(c.getResources(), R.drawable.light_yellow_small);
