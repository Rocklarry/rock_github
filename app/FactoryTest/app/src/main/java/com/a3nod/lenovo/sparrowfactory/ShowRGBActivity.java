...
public class ShowRGBActivity extends Activity {
    ...
    private static double RATIO_JUDGEC= 0.178;
    ...
    private float colortempValue = 5500;
    ...
    public void initConfirmButton()
    {
        ...
        btn_pass.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                ASSYEntity.getInstants().setRGBsensorTestResult(true);
                ASSYEntity.getInstants().RGBSensorValue=currentValue;
        ...
        btn_fail.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                ASSYEntity.getInstants().RGBSensorValue=currentValue;
                ASSYEntity.getInstants().setRGBsensorTestResult(false);
    ...
    private void getRgbDataMethod(){
        ...
        try {
            ...
            if (isVaildData(control2Data)){
                ...
                Log.d(TAG," red ="+red+",green ="+green+",blue ="+blue+" ,lightValue ="+lightValue +",colorValue ="+colorValue);
    ...
    private static class RgbdataHandler extends Handler{
        private WeakReference<ShowRGBActivity> reference;

        public RgbdataHandler(ShowRGBActivity activity){
            reference = new WeakReference<>(activity);
        }
        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            ShowRGBActivity activity = reference.get();
    ...
    private void setValueText(int red,int green,int blue,int brightness,float colortemp,int gain ,long time,int clear){
        ...
        int diff = Math.abs((int)(colortempValue-colortemp));
        if (!btn_pass.isEnabled()&& diff>1000){
