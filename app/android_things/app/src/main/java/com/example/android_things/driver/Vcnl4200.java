...
class Vcnl4200 {
    ...
    public Vcnl4200(String bus) throws IOException {
        ...
        //PeripheralManagerService managerService = new PeripheralManagerService(); 老版本获取
        I2cDevice device = manager.openI2cDevice(bus, I2C_ADDRESS);
        try {
            connect(device);
    ...
    public void enableLightSensor(boolean enabled) throws IOException {
        if (enabled) {
    ...
    public short readLight() throws IOException {
