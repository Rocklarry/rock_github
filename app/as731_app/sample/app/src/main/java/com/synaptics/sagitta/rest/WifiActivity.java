...
public class WifiActivity extends AppCompatActivity {
    ...
    public void setupWifi(View v){
        ...
        Log.i(TAG, "ssid= "+ ssid + " password="+password+ " url="+url+ " postData"+postData);
        ...
        httpService.sendHttpRequest(url, postData);//输入wifi用户名 密码 上传设备
    }
