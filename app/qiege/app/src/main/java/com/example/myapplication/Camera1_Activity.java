...
public class Camera1_Activity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSurfaceView = (SurfaceView)findViewById(R.id.camera_test1);
        mSurfaceHolder = mSurfaceView.getHolder();
        mSurfaceHolder.addCallback(mSurfaceCallback);
        mSurfaceHolder.setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);

        cam_exit = (Button)findViewById(R.id.cam1_exit);
        cam_swith = (Button)findViewById(R.id.cam1_sw);
        cam_up = (Button)findViewById(R.id.cam1_up);
        cam_down = (Button)findViewById(R.id.cam1_down);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.cam1_up:
                stopPreview();
                Intent intent = new Intent(Camera1_Activity.this,Camera2_Activity.class);
