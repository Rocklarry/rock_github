...
public class TTS_Activity extends Activity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    private void initView() {
        ...
        main_btn_read = (Button) findViewById(R.id.tts_btn_read);
        main_edit_text = (EditText) findViewById(R.id.tts_edit_text);
